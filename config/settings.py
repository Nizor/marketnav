...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="marketnav"),
        "USER": config("DB_USER", default="marketnav_user"),
        "PASSWORD": config("DB_PASSWORD", default="marketnav_pass"),
